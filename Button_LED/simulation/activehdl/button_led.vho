...
SIGNAL \Add0~17COUT1_161\ : std_logic;
SIGNAL \Add0~10_combout\ : std_logic;
SIGNAL \Add0~12\ : std_logic;
SIGNAL \Add0~12COUT1_162\ : std_logic;
SIGNAL \Add0~5_combout\ : std_logic;
SIGNAL \Add0~7\ : std_logic;
SIGNAL \Add0~7COUT1_163\ : std_logic;
...
SIGNAL \Add0~102COUT1_177\ : std_logic;
...
SIGNAL \Add0~117COUT1_175\ : std_logic;
...
SIGNAL \Add0~112COUT1_179\ : std_logic;
...
PREV : maxii_lcell
-- Equation(s):
-- \PREV~regout\ = DFFEAS((((!\BUTTON~combout\))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
START : maxii_lcell
-- Equation(s):
-- \START~regout\ = DFFEAS(\START~regout\ $ (((!\PREV~regout\ & ((!\BUTTON~combout\))))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
-- Equation(s):
-- \process_0~0_combout\ = (\BUTTON~combout\) # (((\PREV~regout\)))
...
\Add0~30\ : maxii_lcell
-- Equation(s):
-- \Add0~30_combout\ = (COUNT(6) $ ((!\Add0~27\)))
-- \Add0~32\ = CARRY(((COUNT(6) & !\Add0~27\)))
-- \Add0~32COUT1_165\ = CARRY(((COUNT(6) & !\Add0~27\)))
...
\COUNT[6]\ : maxii_lcell
-- Equation(s):
-- COUNT(6) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~30_combout\, , , VCC)
...
\Add0~35\ : maxii_lcell
-- Equation(s):
-- \Add0~35_combout\ = (COUNT(7) $ (((!\Add0~27\ & \Add0~32\) # (\Add0~27\ & \Add0~32COUT1_165\))))
-- \Add0~37\ = CARRY(((!\Add0~32\) # (!COUNT(7))))
-- \Add0~37COUT1_166\ = CARRY(((!\Add0~32COUT1_165\) # (!COUNT(7))))
...
\COUNT[7]\ : maxii_lcell
-- Equation(s):
-- COUNT(7) = DFFEAS((((\Add0~35_combout\ & !\Equal0~10_combout\))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
\Add0~20\ : maxii_lcell
-- Equation(s):
-- \Add0~20_combout\ = ((!COUNT(0)))
-- \Add0~22\ = CARRY(((COUNT(0))))
...
\COUNT[0]\ : maxii_lcell
-- Equation(s):
-- \Equal0~1\ = (COUNT(6) & (!COUNT(7) & (COUNT[0] & COUNT(5))))
-- COUNT(0) = DFFEAS(\Equal0~1\, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~20_combout\, , , VCC)
...
\Add0~15\ : maxii_lcell
-- Equation(s):
-- \Add0~15_combout\ = (COUNT(1) $ ((\Add0~22\)))
-- \Add0~17\ = CARRY(((!\Add0~22\) # (!COUNT(1))))
-- \Add0~17COUT1_161\ = CARRY(((!\Add0~22\) # (!COUNT(1))))
...
PORT MAP (
	...
	cout0 => \Add0~17\,
	cout1 => \Add0~17COUT1_161\);

-- Location: LC_X2_Y3_N0
\COUNT[1]\ : maxii_lcell
-- Equation(s):
-- COUNT(1) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~15_combout\, , , VCC)
...
\Add0~10\ : maxii_lcell
-- Equation(s):
-- \Add0~10_combout\ = (COUNT(2) $ ((!(!\Add0~22\ & \Add0~17\) # (\Add0~22\ & \Add0~17COUT1_161\))))
-- \Add0~12\ = CARRY(((COUNT(2) & !\Add0~17\)))
-- \Add0~12COUT1_162\ = CARRY(((COUNT(2) & !\Add0~17COUT1_161\)))
...
\COUNT[2]\ : maxii_lcell
-- Equation(s):
-- COUNT(2) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~10_combout\, , , VCC)
...
\Add0~5\ : maxii_lcell
-- Equation(s):
-- \Add0~5_combout\ = COUNT(3) $ (((((!\Add0~22\ & \Add0~12\) # (\Add0~22\ & \Add0~12COUT1_162\)))))
-- \Add0~7\ = CARRY(((!\Add0~12\)) # (!COUNT(3)))
-- \Add0~7COUT1_163\ = CARRY(((!\Add0~12COUT1_162\)) # (!COUNT(3)))
...
PORT MAP (
	...
	cout0 => \Add0~7\,
	cout1 => \Add0~7COUT1_163\);

-- Location: LC_X2_Y3_N3
\COUNT[3]\ : maxii_lcell
-- Equation(s):
-- COUNT(3) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~5_combout\, , , VCC)
...
\Add0~0\ : maxii_lcell
-- Equation(s):
-- \Add0~0_combout\ = (COUNT(4) $ ((!(!\Add0~22\ & \Add0~7\) # (\Add0~22\ & \Add0~7COUT1_163\))))
-- \Add0~2\ = CARRY(((COUNT(4) & !\Add0~7\)))
-- \Add0~2COUT1_164\ = CARRY(((COUNT(4) & !\Add0~7COUT1_163\)))
...
\COUNT[4]\ : maxii_lcell
-- Equation(s):
-- \Equal0~0\ = (COUNT(3) & (COUNT(1) & (COUNT[4] & COUNT(2))))
-- COUNT(4) = DFFEAS(\Equal0~0\, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~0_combout\, , , VCC)
...
\Add0~25\ : maxii_lcell
-- Equation(s):
-- \Add0~25_combout\ = (COUNT(5) $ (((!\Add0~22\ & \Add0~2\) # (\Add0~22\ & \Add0~2COUT1_164\))))
-- \Add0~27\ = CARRY(((!\Add0~2COUT1_164\) # (!COUNT(5))))
...
\COUNT[5]\ : maxii_lcell
-- Equation(s):
-- COUNT(5) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~25_combout\, , , VCC)
...
\Add0~40\ : maxii_lcell
-- Equation(s):
-- \Add0~40_combout\ = (COUNT(8) $ ((!(!\Add0~27\ & \Add0~37\) # (\Add0~27\ & \Add0~37COUT1_166\))))
-- \Add0~42\ = CARRY(((COUNT(8) & !\Add0~37\)))
-- \Add0~42COUT1_167\ = CARRY(((COUNT(8) & !\Add0~37COUT1_166\)))
...
-- Equation(s):
-- COUNT(11) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~55_combout\, , , VCC)
...
\COUNT[8]\ : maxii_lcell
-- Equation(s):
-- \Equal0~2\ = (!COUNT(10) & (!COUNT(9) & (!COUNT[8] & !COUNT(11))))
-- COUNT(8) = DFFEAS(\Equal0~2\, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~40_combout\, , , VCC)
...
\Add0~45\ : maxii_lcell
-- Equation(s):
-- \Add0~45_combout\ = COUNT(9) $ (((((!\Add0~27\ & \Add0~42\) # (\Add0~27\ & \Add0~42COUT1_167\)))))
...
\COUNT[9]\ : maxii_lcell
-- Equation(s):
-- COUNT(9) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~45_combout\, , , VCC)
...
\Add0~50\ : maxii_lcell
-- Equation(s):
-- \Add0~50_combout\ = (COUNT(10) $ ((!(!\Add0~27\ & \Add0~47\) # (\Add0~27\ & \Add0~47COUT1_168\))))
...
-- Equation(s):
-- COUNT(10) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~50_combout\, , , VCC)
...
-- Equation(s):
-- COUNT(12) = DFFEAS(((!\Equal0~10_combout\ & ((\Add0~60_combout\)))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- COUNT(13) = DFFEAS(((!\Equal0~10_combout\ & ((\Add0~65_combout\)))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- COUNT(14) = DFFEAS(((!\Equal0~10_combout\ & ((\Add0~70_combout\)))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- COUNT(15) = DFFEAS((((\Add0~75_combout\ & !\Equal0~10_combout\))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
\Add0~85\ : maxii_lcell
-- Equation(s):
-- \Add0~85_combout\ = (COUNT(16) $ ((!\Add0~77\)))
-- \Add0~87\ = CARRY(((COUNT(16) & !\Add0~77\)))
-- \Add0~87COUT1_173\ = CARRY(((COUNT(16) & !\Add0~77\)))
...
\Add0~80\ : maxii_lcell
-- Equation(s):
-- \Add0~80_combout\ = (COUNT(17) $ (((!\Add0~77\ & \Add0~87\) # (\Add0~77\ & \Add0~87COUT1_173\))))
...
-- Equation(s):
-- COUNT(17) = DFFEAS((((!\Equal0~10_combout\ & \Add0~80_combout\))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- \Equal0~5\ = (((!COUNT[16] & COUNT(17))))
-- COUNT(16) = DFFEAS(\Equal0~5\, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~85_combout\, , , VCC)
...
-- Equation(s):
-- \Add0~115_combout\ = (COUNT(18) $ ((!(!\Add0~77\ & \Add0~82\) # (\Add0~77\ & \Add0~82COUT1_174\))))
-- \Add0~117\ = CARRY(((COUNT(18) & !\Add0~82\)))
-- \Add0~117COUT1_175\ = CARRY(((COUNT(18) & !\Add0~82COUT1_174\)))
...
PORT MAP (
	...
	cout0 => \Add0~117\,
	cout1 => \Add0~117COUT1_175\);

-- Location: LC_X4_Y3_N5
\Add0~100\ : maxii_lcell
-- Equation(s):
-- \Add0~100_combout\ = COUNT(21) $ ((((\Add0~97\))))
-- \Add0~102\ = CARRY(((!\Add0~97\)) # (!COUNT(21)))
-- \Add0~102COUT1_177\ = CARRY(((!\Add0~97\)) # (!COUNT(21)))
...
-- Equation(s):
-- COUNT(21) = DFFEAS((((!\Equal0~10_combout\ & \Add0~100_combout\))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- \Add0~105_combout\ = COUNT(22) $ ((((!(!\Add0~97\ & \Add0~102\) # (\Add0~97\ & \Add0~102COUT1_177\)))))
-- \Add0~107\ = CARRY((COUNT(22) & ((!\Add0~102\))))
-- \Add0~107COUT1_178\ = CARRY((COUNT(22) & ((!\Add0~102COUT1_177\))))
...
-- Equation(s):
-- COUNT(22) = DFFEAS((((!\Equal0~10_combout\ & \Add0~105_combout\))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- \Add0~110_combout\ = (COUNT(23) $ (((!\Add0~97\ & \Add0~107\) # (\Add0~97\ & \Add0~107COUT1_178\))))
-- \Add0~112\ = CARRY(((!\Add0~107\) # (!COUNT(23))))
-- \Add0~112COUT1_179\ = CARRY(((!\Add0~107COUT1_178\) # (!COUNT(23))))
...
-- Equation(s):
-- COUNT(23) = DFFEAS((!\Equal0~10_combout\ & (((\Add0~110_combout\)))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- \Equal0~7\ = (COUNT(19) & (\Equal0~5\ & (!COUNT[18] & \Equal0~6_combout\)))
-- COUNT(18) = DFFEAS(\Equal0~7\, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~115_combout\, , , VCC)
...
\Add0~90\ : maxii_lcell
-- Equation(s):
-- \Add0~90_combout\ = (COUNT(19) $ (((!\Add0~77\ & \Add0~117\) # (\Add0~77\ & \Add0~117COUT1_175\))))
-- \Add0~92\ = CARRY(((!\Add0~117\) # (!COUNT(19))))
-- \Add0~92COUT1_176\ = CARRY(((!\Add0~117COUT1_175\) # (!COUNT(19))))
...
-- Equation(s):
-- COUNT(19) = DFFEAS((((!\Equal0~10_combout\ & \Add0~90_combout\))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
\Add0~95\ : maxii_lcell
-- Equation(s):
-- \Add0~95_combout\ = (COUNT(20) $ ((!(!\Add0~77\ & \Add0~92\) # (\Add0~77\ & \Add0~92COUT1_176\))))
-- \Add0~97\ = CARRY(((COUNT(20) & !\Add0~92COUT1_176\)))
...
-- Equation(s):
-- COUNT(20) = DFFEAS((((!\Equal0~10_combout\ & \Add0~95_combout\))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- \Add0~125_combout\ = (COUNT(24) $ ((!(!\Add0~97\ & \Add0~112\) # (\Add0~97\ & \Add0~112COUT1_179\))))
-- \Add0~127\ = CARRY(((COUNT(24) & !\Add0~112\)))
-- \Add0~127COUT1_180\ = CARRY(((COUNT(24) & !\Add0~112COUT1_179\)))
...
-- Equation(s):
-- COUNT(27) = DFFEAS((((\Add0~135_combout\))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- \Equal0~8\ = (!COUNT(26) & (COUNT(25) & (!COUNT[24] & !COUNT(27))))
-- COUNT(24) = DFFEAS(\Equal0~8\, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~125_combout\, , , VCC)
...
-- Equation(s):
-- \Add0~120_combout\ = (COUNT(25) $ (((!\Add0~97\ & \Add0~127\) # (\Add0~97\ & \Add0~127COUT1_180\))))
...
-- Equation(s):
-- COUNT(25) = DFFEAS((((!\Equal0~10_combout\ & \Add0~120_combout\))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- COUNT(26) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~130_combout\, , , VCC)
...
-- Equation(s):
-- \Equal0~4_combout\ = (\Equal0~3_combout\ & (\Equal0~0\ & (\Equal0~1\ & \Equal0~2\)))
...
-- Equation(s):
-- COUNT(30) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~150_combout\, , , VCC)
...
-- Equation(s):
-- COUNT(31) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~155_combout\, , , VCC)
...
-- Equation(s):
-- \Equal0~9\ = (!COUNT(29) & (!COUNT(30) & (!COUNT[28] & !COUNT(31))))
-- COUNT(28) = DFFEAS(\Equal0~9\, GLOBAL(\CLK~combout\), VCC, , \START~regout\, \Add0~140_combout\, , , VCC)
...
-- Equation(s):
-- COUNT(29) = DFFEAS((((\Add0~145_combout\))), GLOBAL(\CLK~combout\), VCC, , \START~regout\, , , , )
...
-- Equation(s):
-- \Equal0~10_combout\ = (\Equal0~8\ & (\Equal0~7\ & (\Equal0~4_combout\ & \Equal0~9\)))
...
TOGGLE : maxii_lcell
-- Equation(s):
-- \TOGGLE~regout\ = DFFEAS((\TOGGLE~regout\ & (\process_0~0_combout\ & ((!\Equal0~10_combout\) # (!\START~regout\)))) # (!\TOGGLE~regout\ & (\START~regout\ & ((\Equal0~10_combout\)))), GLOBAL(\CLK~combout\), VCC, , , , , , )
