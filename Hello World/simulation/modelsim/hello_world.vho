...
SIGNAL \Add0~62COUT1_171\ : std_logic;
SIGNAL \Add0~65_combout\ : std_logic;
SIGNAL \Add0~75_combout\ : std_logic;
SIGNAL \Add0~67\ : std_logic;
SIGNAL \Add0~67COUT1_172\ : std_logic;
...
SIGNAL \Add0~127COUT1_181\ : std_logic;
...
\COUNT[3]\ : maxii_lcell
-- Equation(s):
-- \Equal0~1\ = (!COUNT(1) & (!COUNT(0) & (!COUNT[3] & !COUNT(2))))
...
\COUNT[6]\ : maxii_lcell
-- Equation(s):
-- COUNT(6) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , , \Add0~5_combout\, , , VCC)
...
\COUNT[7]\ : maxii_lcell
-- Equation(s):
-- \Equal0~0\ = (!COUNT(4) & (!COUNT(6) & (!COUNT[7] & !COUNT(5))))
-- COUNT(7) = DFFEAS(\Equal0~0\, GLOBAL(\CLK~combout\), VCC, , , \Add0~0_combout\, , , VCC)
...
\COUNT[8]\ : maxii_lcell
-- Equation(s):
-- COUNT(8) = DFFEAS(((\Add0~40_combout\ & ((!\Equal0~9_combout\) # (!\Equal0~4_combout\)))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
\COUNT[9]\ : maxii_lcell
-- Equation(s):
-- \Equal0~2\ = (!COUNT(10) & (COUNT(8) & (!COUNT[9] & !COUNT(11))))
-- COUNT(9) = DFFEAS(\Equal0~2\, GLOBAL(\CLK~combout\), VCC, , , \Add0~45_combout\, , , VCC)
...
-- Equation(s):
-- COUNT(10) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , , \Add0~50_combout\, , , VCC)
...
\Add0~75\ : maxii_lcell
-- Equation(s):
-- \Add0~75_combout\ = (COUNT(12) $ ((!(!\Add0~52\ & \Add0~57\) # (\Add0~52\ & \Add0~57COUT1_169\))))
-- \Add0~77\ = CARRY(((COUNT(12) & !\Add0~57\)))
-- \Add0~77COUT1_170\ = CARRY(((COUNT(12) & !\Add0~57COUT1_169\)))
...
\Add0~60\ : maxii_lcell
-- Equation(s):
-- \Add0~60_combout\ = COUNT(13) $ (((((!\Add0~52\ & \Add0~77\) # (\Add0~52\ & \Add0~77COUT1_170\)))))
-- \Add0~62\ = CARRY(((!\Add0~77\)) # (!COUNT(13)))
-- \Add0~62COUT1_171\ = CARRY(((!\Add0~77COUT1_170\)) # (!COUNT(13)))
...
PORT MAP (
	...
	cout0 => \Add0~62\,
	cout1 => \Add0~62COUT1_171\);

-- Location: LC_X5_Y2_N8
\Add0~65\ : maxii_lcell
-- Equation(s):
-- \Add0~65_combout\ = (COUNT(14) $ ((!(!\Add0~52\ & \Add0~62\) # (\Add0~52\ & \Add0~62COUT1_171\))))
-- \Add0~67\ = CARRY(((COUNT(14) & !\Add0~62\)))
-- \Add0~67COUT1_172\ = CARRY(((COUNT(14) & !\Add0~62COUT1_171\)))
...
-- Equation(s):
-- COUNT(14) = DFFEAS(((\Add0~65_combout\ & ((!\Equal0~9_combout\) # (!\Equal0~4_combout\)))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
\Add0~70\ : maxii_lcell
-- Equation(s):
-- \Add0~70_combout\ = COUNT(15) $ (((((!\Add0~52\ & \Add0~67\) # (\Add0~52\ & \Add0~67COUT1_172\)))))
-- \Add0~72\ = CARRY(((!\Add0~67COUT1_172\)) # (!COUNT(15)))
...
-- Equation(s):
-- COUNT(15) = DFFEAS(((\Add0~70_combout\ & ((!\Equal0~9_combout\) # (!\Equal0~4_combout\)))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
-- COUNT(12) = DFFEAS(\Equal0~3\, GLOBAL(\CLK~combout\), VCC, , , \Add0~75_combout\, , , VCC)
...
-- Equation(s):
-- COUNT(13) = DFFEAS(((\Add0~60_combout\ & ((!\Equal0~4_combout\) # (!\Equal0~9_combout\)))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
\Add0~80\ : maxii_lcell
-- Equation(s):
-- \Add0~80_combout\ = COUNT(16) $ ((((!\Add0~72\))))
-- \Add0~82\ = CARRY((COUNT(16) & ((!\Add0~72\))))
-- \Add0~82COUT1_173\ = CARRY((COUNT(16) & ((!\Add0~72\))))
...
\Add0~90\ : maxii_lcell
-- Equation(s):
-- \Add0~90_combout\ = (COUNT(17) $ (((!\Add0~72\ & \Add0~82\) # (\Add0~72\ & \Add0~82COUT1_173\))))
-- \Add0~92\ = CARRY(((!\Add0~82\) # (!COUNT(17))))
-- \Add0~92COUT1_174\ = CARRY(((!\Add0~82COUT1_173\) # (!COUNT(17))))
...
-- COUNT(17) = DFFEAS(\Equal0~5\, GLOBAL(\CLK~combout\), VCC, , , \Add0~90_combout\, , , VCC)
...
\Add0~85\ : maxii_lcell
-- Equation(s):
-- \Add0~85_combout\ = (COUNT(18) $ ((!(!\Add0~72\ & \Add0~92\) # (\Add0~72\ & \Add0~92COUT1_174\))))
-- \Add0~87\ = CARRY(((COUNT(18) & !\Add0~92\)))
-- \Add0~87COUT1_175\ = CARRY(((COUNT(18) & !\Add0~92COUT1_174\)))
...
\Add0~95\ : maxii_lcell
-- Equation(s):
-- \Add0~95_combout\ = COUNT(19) $ (((((!\Add0~72\ & \Add0~87\) # (\Add0~72\ & \Add0~87COUT1_175\)))))
-- \Add0~97\ = CARRY(((!\Add0~87\)) # (!COUNT(19)))
-- \Add0~97COUT1_176\ = CARRY(((!\Add0~87COUT1_175\)) # (!COUNT(19)))
...
-- Equation(s):
-- \Add0~100_combout\ = (COUNT(20) $ ((!(!\Add0~72\ & \Add0~97\) # (\Add0~72\ & \Add0~97COUT1_176\))))
-- \Add0~102\ = CARRY(((COUNT(20) & !\Add0~97COUT1_176\)))
...
-- Equation(s):
-- \Equal0~6_combout\ = (COUNT(23) & (COUNT(22) & (COUNT(21) & COUNT(20))))
...
-- Equation(s):
-- \Add0~130_combout\ = COUNT(25) $ (((((!\Add0~102\ & \Add0~122\) # (\Add0~102\ & \Add0~122COUT1_180\)))))
-- \Add0~132\ = CARRY(((!\Add0~122COUT1_180\)) # (!COUNT(25)))
...
-- Equation(s):
-- \Add0~125_combout\ = COUNT(26) $ ((((!\Add0~132\))))
-- \Add0~127\ = CARRY((COUNT(26) & ((!\Add0~132\))))
-- \Add0~127COUT1_181\ = CARRY((COUNT(26) & ((!\Add0~132\))))
...
PORT MAP (
	...
	cout0 => \Add0~127\,
	cout1 => \Add0~127COUT1_181\);

-- Location: LC_X7_Y2_N1
\Add0~135\ : maxii_lcell
-- Equation(s):
-- \Add0~135_combout\ = COUNT(27) $ (((((!\Add0~132\ & \Add0~127\) # (\Add0~132\ & \Add0~127COUT1_181\)))))
-- \Add0~137\ = CARRY(((!\Add0~127\)) # (!COUNT(27)))
-- \Add0~137COUT1_182\ = CARRY(((!\Add0~127COUT1_181\)) # (!COUNT(27)))
...
-- Equation(s):
-- COUNT(27) = DFFEAS((((\Add0~135_combout\))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
-- Equation(s):
-- \Equal0~7\ = (COUNT(26) & (COUNT(24) & (!COUNT[25] & !COUNT(27))))
-- COUNT(25) = DFFEAS(\Equal0~7\, GLOBAL(\CLK~combout\), VCC, , , \Add0~130_combout\, , , VCC)
...
-- Equation(s):
-- COUNT(26) = DFFEAS(((\Add0~125_combout\ & ((!\Equal0~9_combout\) # (!\Equal0~4_combout\)))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
-- Equation(s):
-- \Add0~140_combout\ = (COUNT(28) $ ((!(!\Add0~132\ & \Add0~137\) # (\Add0~132\ & \Add0~137COUT1_182\))))
...
-- Equation(s):
-- \Add0~145_combout\ = (COUNT(29) $ (((!\Add0~132\ & \Add0~142\) # (\Add0~132\ & \Add0~142COUT1_183\))))
...
-- Equation(s):
-- \Add0~150_combout\ = (COUNT(30) $ ((!(!\Add0~132\ & \Add0~147\) # (\Add0~132\ & \Add0~147COUT1_184\))))
...
-- Equation(s):
-- \Equal0~8\ = (!COUNT(30) & (!COUNT(31) & (!COUNT[28] & !COUNT(29))))
...
-- Equation(s):
-- \Equal0~9_combout\ = (\Equal0~6_combout\ & (\Equal0~7\ & (\Equal0~5\ & \Equal0~8\)))
...
TOGGLE : maxii_lcell
-- Equation(s):
-- \TOGGLE~regout\ = DFFEAS((\TOGGLE~regout\ $ (((\Equal0~9_combout\ & \Equal0~4_combout\)))), GLOBAL(\CLK~combout\), VCC, , , , , , )
